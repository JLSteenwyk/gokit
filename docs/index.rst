...
.. figure:: ../_static/img/figures/realistic_term_bar.png
   ...
   Larger term-bar figure generated from ``examples/data/realistic_plots/all_studies.tsv``.

.. figure:: ../_static/img/figures/realistic_direction_summary.png
   :width: 100%
   :alt: Example directional summary figure generated by gokit

   Larger direction-summary figure generated from ``examples/data/realistic_plots/all_studies.tsv``.

.. figure:: ../_static/img/figures/realistic_semantic_network.png
   :width: 100%
   :alt: Example semantic network figure generated by gokit

   Larger semantic-network figure generated from ``examples/data/realistic_plots/semantic_similarity.tsv``.
