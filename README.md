...
![Term bar plot](examples/figures/realistic_term_bar.png)

Direction summary plot (`--kind direction-summary`):

![Direction summary plot](examples/figures/realistic_direction_summary.png)

Semantic network plot (`--kind semantic-network`, 8-study matrix):

![Semantic network plot](examples/figures/realistic_semantic_network.png)
